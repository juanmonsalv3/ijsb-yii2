...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="inscripciones-index">
            ...
            <div class="col-md-12">
                <div class="col-md-4">
                    <?= $f->field($form, 'proximo_grupo')->dropDownList($grupos)?>
                </div>
            </div>
            <div class="col-md-12">
                <div class="col-md-4">
            ...
            <div class="col-md-12 form-group">
                <div class="col-md-12 form-group">
                    <?= Html::submitButton('<span class="glyphicon glyphicon-floppy-disk"></span> Matricular', ['class' => 'btn btn-primary','confirm'=>'Are you sure you want to save?']) ?>    
                </div>
            </div>
            <?php $f->end();?>
        </div>
