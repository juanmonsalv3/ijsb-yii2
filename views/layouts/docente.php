        ...
        <div class="row">
            <div class="col-md-3 side-left">
                ...
                <div class="list-group">
                    <?php
                    $variosgrupos = Yii::$app->session->get('varios_grupos');
                    ?>
                    <?php if($variosgrupos!== null && $variosgrupos === true){?>
                    <a href="<?=Url::toRoute(["docente/grupos"])?>" class="list-group-item">Grupos Asignados</a>
                    <?php }?>
                    <a href="<?=Url::toRoute(["docente/grupo"])?>" class="list-group-item">Grupo</a>
                </div>
                <hr/>
