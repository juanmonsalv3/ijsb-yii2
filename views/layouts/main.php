        ...
        <div class="row">
            <div class="col-md-3 side-left">
                ...
                <div class="list-group">
                    <a href="<?=Url::toRoute(["inscripciones/"])?>" class="list-group-item">Inscripciones</a>
                    <a href="<?=Url::toRoute(["matricula/"])?>" class="list-group-item">Matriculas</a>
                    <a href="<?=Url::toRoute(["estudiantes/"])?>" class="list-group-item">Estudiantes</a>
                    <a href="<?=Url::toRoute(["grupos/"])?>" class="list-group-item">Grupos</a>
                    <a href="<?=Url::toRoute(["indicadores/"])?>" class="list-group-item">Indicadores</a>
                    <a href="<?=Url::toRoute(["usuarios/"])?>" class="list-group-item">Usuarios</a>
                    <a href="<?=Url::toRoute(["parametros/"])?>" class="list-group-item">Configuración</a>
                </div>
                <hr/>
